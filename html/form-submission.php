				...
				<?php 
				  ...
				  $zip = $_POST["zip"];
					...
					if ($conn->query($sql) === TRUE) {
					  echo "<p style='text-align: center;'>Thank you for registering for our service. We will get back to you shortly.<br>The <a href='http://delegateit.co'>Delegateit</a> Team.</p>";
					} else {
